...
import 'package:mentalwellness/components/custom_textformfield.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  showErrorBottomSheet(context, errors);
    ...
    StoreProvider.of<GlobalState>(context).dispatch(
      SignUpAction(_firstNameController.text, _lastNameController.text, _emailController.text, _passwordController.text),
    );
  }
} 
  ...
  isInputEmpty: _firstNameController.text.isEmpty,
                  onChanged: (value) => setState(() => _firstNameController.text = value),
  onClear: () => setState(() => _firstNameController.text = ''),
  initialValue: _firstNameController.text,
),
const SizedBox(height: 20,),
                      CustomTextFormField(
  labelText: 'Last Name',
  isInputEmpty: _lastNameController.text.isEmpty,
                  onChanged: (value) => setState(() => _lastNameController.text = value),
  onClear: () => setState(() => _lastNameController.text = ''),
